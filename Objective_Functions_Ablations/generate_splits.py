"""
Generate Persistent 10-Fold Stratified CV Splits
=================================================
Run this script ONCE before starting any ablation experiments.
...
Source data: data/processed/raw_features_cnv_ablation.csv
  - Our own preprocessed 500-gene CNV features with survival labels.
  - NOT the authors' pre-extracted VAE features.
...
Output:
  Objective_Functions_Ablations/splits/splits_10fold.json
"""
...
# Use the ablation raw features file — our own preprocessed 500-gene CNV
# features with labels, NOT the authors' pre-extracted VAE features.
...
def main(args):
    ...
    payload = {
        ...
        "note": (
            ...
            "ALL ablation runs must use these same splits. "
    ...
    print("Use this file in ALL ablation runs to ensure identical evaluation splits.")


if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Generate persistent 10-fold stratified CV splits for ablations.',
    ...
    parser.add_argument('--output_name', type=str, default='splits_10fold.json',
                        help='Output filename inside ablations/splits/')
