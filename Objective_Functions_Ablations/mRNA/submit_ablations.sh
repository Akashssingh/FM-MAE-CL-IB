#!/bin/bash
# Submit all 4 mRNA ablation combinations as separate SLURM jobs.
#
# Usage:
#   cd /home/a/akashsingh/FM-MAE-CL-IB
#   bash Objective_Functions_Ablations/mRNA/submit_ablations.sh

set -euo pipefail
cd "$(dirname "$0")/../.."   # project root

SLURM_SCRIPT="Objective_Functions_Ablations/mRNA/run_ablation.slurm"

echo "Submitting 4 mRNA ablation jobs..."
echo ""
...
echo "Results:  Objective_Functions_Ablations/mRNA/results/"
echo "Logs:     Objective_Functions_Ablations/mRNA/logs/"
